...
> ### Kitchen Inventory (CRUD,advanced patterns) that adheres to the [RealWorld](https://github.com/gothinkster/realworld-example-apps) spec and API.


<a href="https://stackblitz.com/edit/angular-realworld" target="_blank"><img width="187" src="https://github.com/ikhlaq1/realworld/kitchen-inventory-angular-app/edit_on_blitz.png?raw=true" /></a>&nbsp;&nbsp;
